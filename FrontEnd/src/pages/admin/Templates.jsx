    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-slate-400">Configure reusable workflow stages, document checklists, and standard tasks</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-panel p-5 space-y-3 border-t-4 border-t-blue-500">
          <div className="flex justify-between items-start">
            ...
            <span className="px-2 py-0.5 text-[10px] bg-blue-950 text-blue-300 rounded font-bold">6 Stages</span>
          </div>
          <p className="text-xs text-slate-400">Default 6-stage petition template with Dhanasar 3-prong checklists and recommendation letter tasks.</p>
